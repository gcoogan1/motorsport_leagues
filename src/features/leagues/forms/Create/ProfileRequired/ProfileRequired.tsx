...
const ProfileRequiredForm = () => {
  ...
  return (
    <FormBlock 
      ...
      helperMessage='To create a League, you need to have a Profile that is a member of a Squad. Continue to create your first Profile.'
      buttons={{
