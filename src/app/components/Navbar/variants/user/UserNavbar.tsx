    ...
    <NavLayout ref={ref}>
      ...
      {!isMobile ? (
        <>
          <CenterContainer>
            <>
              <NavSelect icon={<Profile />} label={"Profiles"} onClick={() => openPanelOfType("PROFILES")} />
              <NavSelect icon={<Squad />} label={"Squads"} onClick={() => openPanelOfType("SQUADS")} />
              <NavSelect icon={<League />} label={"Leagues"} onClick={() => openPanelOfType("LEAGUES")} />
            </>
          </CenterContainer>
          <RightContainer>
            {(user && !loading) && (
              <>
                  <NavNotification count={countNotifications} onClick={() => openPanelOfType("NOTIFICATIONS")} />
                  <NavAccount label={accountLabel} onClick={() => openPanelOfType("ACCOUNT")} />
              </>
            )}
          </RightContainer>
        </>
